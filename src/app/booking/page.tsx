...
export default function BookingPage() {
  ...
  const bgImage = 'https://images.unsplash.com/photo-1537204696486-967f1b7198c8?auto=format&fit=crop&w=1600&q=80';

  if (sent) return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px', backgroundImage: `linear-gradient(rgba(244,239,234,0.22), rgba(244,239,234,0.22)), url(${bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
  ...
  return (
    <main onClick={closeAll} style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 16px', backgroundImage: `linear-gradient(rgba(244,239,234,0.22), rgba(244,239,234,0.22)), url(${bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div style={{ width: '100%', maxWidth: '480px', backgroundColor: 'white', padding: '28px 24px', borderRadius: '20px', border: `3px solid ${colors.textDark}`, boxShadow: `8px 8px 0px ${colors.textDark}` }} onClick={e => e.stopPropagation()}>
        <h1 style={{ fontFamily: fonts.heading, fontSize: 'clamp(32px, 8vw, 42px)', color: colors.textDark, margin: '0 0 24px 0', lineHeight: 1.1 }}>Book Appointment</h1>
