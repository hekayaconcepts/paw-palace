...
function BeforeAfter({ before, after, breed, service }: BeforeAfterProps) {
  ...
  return (
    <div
      ...
      style={{ position: 'relative', overflow: 'hidden', borderRadius: 4, backgroundColor: '#000', boxShadow: '0 10px 24px rgba(61,43,31,0.12)', cursor: 'ew-resize' }}
    >
      <div style={{ position: 'relative', width: '100%', paddingBottom: '125%' }}>
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, width: `${pos}%`, height: '100%', overflow: 'hidden' }}>
          <img src={before} alt={`${breed} before`} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', objectFit: 'cover' }} />
        </div>
...
export default function GalleryPage() {
  const items: Array<BeforeAfterProps> = [
    { breed: 'Goldendoodle', service: 'Full Groom & Teddy Bear Cut', before: 'https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?w=800&auto=format', after: 'https://images.unsplash.com/photo-1558788353-f76d92427f16?w=800&auto=format' },
    { breed: 'Standard Poodle', service: 'Scissor Cut & Spa', before: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?w=800&auto=format', after: 'https://images.unsplash.com/photo-1615751073681-1f9c6ef1c1b7?w=800&auto=format' },
    { breed: 'Shih Tzu', service: 'Puppy Cut', before: 'https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=800&auto=format', after: 'https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?w=800&auto=format' },
    { breed: 'Bernedoodle', service: 'De-matt & Full Groom', before: 'https://images.unsplash.com/photo-1560743641-3914f2c45636?w=800&auto=format', after: 'https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=800&auto=format' },
    { breed: 'Bichon Frise', service: 'Breed Standard Cut', before: 'https://images.unsplash.com/photo-1591946614720-90a587da4a36?w=800&auto=format', after: 'https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?w=800&auto=format' },
    { breed: 'Mini Poodle', service: 'Asian Fusion Style', before: 'https://images.unsplash.com/photo-1558788353-f76d92427f16?w=800&auto=format', after: 'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?w=800&auto=format' },
  ]
